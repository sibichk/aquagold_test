...
<div class="mid_center">
  ...
  <div class="box">
    <div class="heading">
      <h1><!--<img src="admin/view/image/customer.png" alt="" />--> <?php echo $heading_title; ?></h1>
      <h2>Attract more customers by offering them a discount when they use the giftcard. Set yours now.</h2>
      <h3><i>*If you opt not to offer a discount, you can set it to 0%. Customers will also be able to see the discount rate in physician search results.</i></h3><br />
        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td><!--<input type="text" name="discount" value="<?php echo (int)$discount; ?>" size="12" /> %-->
                <select name="discount">
                <option value="" <?php if($discount == '') echo 'selected'; ?>>Choose</option>
                <option value="0" <?php if($discount === 0) echo 'selected'; ?>>0%</option>
                <option value="5" <?php if((int)$discount == 5) echo 'selected'; ?>>5%</option>
                <option value="10" <?php if((int)$discount == 10) echo 'selected'; ?>>10%</option>
                <option value="15" <?php if((int)$discount == 15) echo 'selected'; ?>>15%</option>
                <option value="20" <?php if((int)$discount == 20) echo 'selected'; ?>>20%</option>
                </select>
            ...
            <tr>
              ...
              <td><input type="text" name="date_end" value="<?php echo $date_end; ?>" size="12" id="date-end" />
                <?php if ($error_date) { ?>
