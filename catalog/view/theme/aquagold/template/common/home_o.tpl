    ...
    <section class="body_container" id="body_container">
      ...
      <article class="top_left_text">
        <div class="skin_text" style="width:auto;">the perfect finishing<br>
          ...
          <div class="patient_text" style="line-height:normal; font-weight:normal; text-transform:none;">AQUAGOLD<sup>&reg;</sup> <span style="font-family:'Segoe Script';">fine touch</span><sup>&trade;</sup> <br /> <br />
...
The patented microneedle technology improves the transfer efficiency of active ingredients into the skin without pain.</div>
          ...
          <span id="push_down" style="float:right; text-transform:none;"><a href="javascript:;" id="flip2"><img src="catalog/view/theme/aquagold/image/push_down.png" width="26" height="19" alt="img"></a> <a href="<?php echo $faq; ?>" style="margin-left:50px;">Learn more &gt;&gt;</a></span>
          </aside> <img src="catalog/view/theme/aquagold/image/product.jpg"> </div>
      ...
      <article class="full_row">
        <aside class="patients_box">
          <div class="patient_text">Patients</div>
          
            <div class="row_one"><span>Find a Physician</span>
            ...
            <div class="row_one"><a href="<?php echo $voucher; ?>"><span style="width:256px;">Buy Giftcard for friends</span></a></div>
        ...
        <aside class="patients_box_sec">
          <div class="patient_text">Physicians</div>
          <form action="<?php echo $reward; ?>" method="post">
            <div class="row_one"><span>Redeem Giftcard</span>
              <input name="code" type="text" value="" class="zip_code" placeholder="Act. code" required>
              <input type="submit" class="save_button" value="GO">
            </div>
            <div class="row_one"><a href="<?php echo $product; ?>"><span style="width:256px;">Order <font color="#79601e">AQUAGOLD<sup>&reg;</sup> <span style="font-family:'Segoe Script'; color:#79601e; float:none;">fine touch</span><sup>&trade;</sup></font></span></a> <a href="<?php echo $voucher; ?>"><span style="width:256px;">or Heart of Gold Gift Cards</span></a></div>
