    ...
    <div class="right">
      ...
      <div class="cart" style="margin-top:20px;">
        <div><?php echo $text_qty; ?>
          ...
          &nbsp;
          <input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="button" /> <?php echo $cart; ?> <input type="button" value="Go to Cart" class="button" onclick="location.href='<?php echo $scart; ?>'" style="float:right; margin-right:120px; margin-top:-35px;" />
