...
class ControllerAccountSuccess extends Controller {  
	public function index() {
		...
		if(isset($this->session->data['promo_message'])) {
			$this->data['heading_title'] = $this->session->data['promo_message'];
		} else {
		...
		/*if(isset($this->session->data['promo_message'])) {
			$this->data['text_message'] = $this->session->data['promo_message'] .'<br><br>'. $this->data['text_message'];
			unset($this->session->data['promo_message']);
		}*/
