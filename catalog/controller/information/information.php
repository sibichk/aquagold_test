	...
	public function index() {  
		...
		if ($information_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/information.tpl')) {
				if($information_id == 7)
				$this->template = $this->config->get('config_template') . '/template/information/information_fullview.tpl';
				else
