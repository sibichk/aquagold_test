        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'c.date_added') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'c.customer_type') { ?>
                <a href="<?php echo $sort_customer_type; ?>" class="<?php echo strtolower($order); ?>">Customer Type</a>
                <?php } else { ?>
                <a href="<?php echo $sort_customer_type; ?>">Customer Type</a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo ($customer['customer_type'] == 1) ? 'Physician' : 'Patient'; ?></td>
